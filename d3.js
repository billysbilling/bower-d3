d3 = function() {
  ...
  d3.layout.pie = function() {
    var value = Number, sort = d3_layout_pieSortByValue, spacing = 0, startAngle = 0, endAngle = 2 * π;
    function pie(data) {
      var len = data.length;
      var values = data.map(function(d, i) {
        return +value.call(pie, d, i);
      });
      var s = len > 1 ? +(typeof spacing === "function" ? spacing.apply(this, arguments) : spacing) : 0;
      var spaceCount = endAngle - startAngle === 2 * π ? len : len - 1;
      var a = +(typeof startAngle === "function" ? startAngle.apply(this, arguments) : startAngle);
      var k = ((typeof endAngle === "function" ? endAngle.apply(this, arguments) : endAngle) - a - s * spaceCount) / d3.sum(values);
